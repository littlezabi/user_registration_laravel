<x-layout>
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form method="POST" action="/user/login" class="space-y-6" action="#" method="POST">
                @csrf
                <h2 class="text-3xl uppercase text-center  font-bold">Login into account</h2>
                <div>
            ...
            <p class="mt-10 text-center text-sm text-gray-500">
                Not have an account
                <a href="/user/create" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Sign
                    Up.</a>
            </p>
        </div>
    </div>
